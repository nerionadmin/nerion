...
const MIN_FACE_WIDTH_N  = OVAL_W_N * (mobile ? 1.50 : 0.60);
const MAX_FACE_WIDTH_N  = OVAL_W_N * (mobile ? 2.50 : 0.96);
const MIN_FACE_HEIGHT_N = OVAL_H_N * (mobile ? 1.50 : 0.60);
const MAX_FACE_HEIGHT_N = OVAL_H_N * (mobile ? 2.50 : 0.96);
